...
import { gettingFiveCities, gettingNewYork } from "../store/thunks";
        ...
        {this.props.cities.length ? (
          <React.Fragment>
            <div className="city-title">
              {this.props.cities[0].list[0].name}
            </div>
              ...
              <div className="content-container-left">
                <div className="temp-container">
                  ...
                  <div className="card-temp">
                    {Math.trunc(this.props.cities[0].list[0].main.temp)}
                    &deg;
                  ...
                  <div className="card-low-high">
                    ...
                    <span className="small-deg">
                      {Math.trunc(this.props.cities[0].list[0].main.temp_min)}
                      &deg;
                    </span>
                  ...
                  <div className="card-low-high">
                    ...
                    <span className="small-deg">
                      {Math.trunc(this.props.cities[0].list[0].main.temp_max)}
                      &deg;
                    </span>
                    <span className="small-f">F</span>
                  </div>
                    ...
                    <tbody>
                      <tr className="row">
                        ...
                        <td className="description">
                          {this.props.cities[0].list[0].weather[0].description}
                        </td>
                      </tr>
                      ...
                      <tr className="row">
                        ...
                        <td className="description">
                          {this.props.cities[0].list[0].main.humidity}
                        </td>
                      </tr>
                      ...
                      <tr className="row">
                        ...
                        <td className="description">
                          {this.props.cities[0].list[0].wind.speed} mph
                        </td>
                      </tr>
                      ...
                      <tr className="row">
                        ...
                        <td className="description">
                          {this.getTime(
                            this.props.cities[0].list[0].sys.sunrise
                          )}
                        </td>
                      </tr>
                      ...
                      <tr className="row">
                        ...
                        <td className="description">
                          {this.getTime(
                            this.props.cities[0].list[0].sys.sunset
                          )}
                        </td>
                      </tr>
                    </tbody>
...
const mapDispatchToProps = dispatch => ({
  ...
  fetchNewYork: () => gettingNewYork(dispatch)
});
